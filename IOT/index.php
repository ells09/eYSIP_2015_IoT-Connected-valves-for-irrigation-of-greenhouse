...
if(isset($_GET['grp']))
{
	...
	{	$i=1;
		...
		{	
			...
			echo "<b style='color:#3B5998;font-weight:bold;'>Valve ".$i."</b>&nbsp; &nbsp;<bstyle='color:#3B5998;font-weight:bold;'>Group:</b> $name &nbsp; <button class='item' id='$macid' type='button' onclick='update(this.value)' value='$macid'>Switch ".$action."</button> &nbsp; &nbsp; ".$status."<hr>";
			$i++;
