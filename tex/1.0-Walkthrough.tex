...
%  \begin{center}\rule{3in}{0.4pt}\end{center}
  ...
  {\Large{\item{Step 1---Install Apache}}}

  To install apache, open terminal and type in these commands: \textbf{For
  Ubuntu} \texttt{sudo apt-get update}
  ...
  FW\_CONFIGURATIONS\_EXT in /etc/sysconfig/SuSEfirewall2
